							...
							<#list specList as spec>
								<dl>
									...
									<#list spec.attributeValue as item>
										<dd>
											<a class="{{isSelected('${spec.attributeName}', '${item}')?'selected':''}}" ng-click="selectSpecification('${spec.attributeName}', '${item}')">${item}
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a <#--href="../../../../../pinyougou-portal-web/src/main/resources/templates/cart.html"--> target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addToCart()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
